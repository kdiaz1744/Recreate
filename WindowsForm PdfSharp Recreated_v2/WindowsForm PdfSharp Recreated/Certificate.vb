...
Public Class Certificate
    ...
    Private Data_Recieved As String
    Private PO_Number As String

    Public Sub New(SupplierT As String, Data_RecievedT As String, PO_NumberT As String)
        Supplier = SupplierT
        Data_Recieved = Data_RecievedT
        PO_Number = PO_NumberT
    End Sub
    ...
    Public Sub CreatePage()
        ...
        row.Cells(3).AddParagraph(Data_Recieved)
        ...
        '-----
        row.Cells(1).Format.Font.Size = 10
        row.Cells(1).AddParagraph(PO_Number)
        row.Cells(1).Format.Alignment = ParagraphAlignment.Center
        row.Cells(1).VerticalAlignment = VerticalAlignment.Center
        '-----
        row.Cells(2).Format.Font.Size = 11
        ...
        For i As Integer = 1 To 7
            ...
            Else
                ...
                Table2Row.Cells(i).Format.Alignment = ParagraphAlignment.Center
