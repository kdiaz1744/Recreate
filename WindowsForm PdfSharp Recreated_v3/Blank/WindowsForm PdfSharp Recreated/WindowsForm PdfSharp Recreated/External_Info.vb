...
Public Class Document_info
    ...
    Public Class Non_Table
        Public Property Sample_Amount As Integer = 0
    ...
    Public Class First_Table
        ...
        Public Property Data_Recieved As String = ""
        Public Property PO_Number As String = ""
        Public Property Reciever_Number As String = ""
        Public Property ManuExpi_Date As String = ""
        Public Property CareVendor_Number As String = ""
        Public Property Part_Number As String = ""
        Public Property RMS_Revision As String = ""
        Public Property Quantity As String = ""
        Public Property Containers_Recieved As String = ""
        Public Property Unit_of_Measure As String = ""
        Public Property BoxRoll_Number As String = ""
        Public Property Resin_Number As String = ""
        Public Property Inspection_Level As String = "Reduced  Normal  Tightened "
        Public Property Sampled_By As String = ""
        Public Property Data_Sampled As String = ""
    End Class
    '------

    Public Table2 As Second_Table = New Second_Table
    Public Class Second_Table
        Public Sampling_Level = New String() {"", "", "", "", ""}
        Public AQL = New String() {"", "", "", "", ""}
        Public Sampling_Size = New String() {"", "", "", "", ""}
        Public Accept = New Integer() {0, 0, 0, 0, 0}
        Public Reject = New Integer() {0, 0, 0, 0, 0}
        Public Number_Of_Defects = New String() {"", "", "", "", ""}
        Public Type_Of_Defect = New String() {"", "", "", "", ""}
        Public Pass_Fail = New String() {"", "", "", "", ""}
    End Class
    '------

    Public Table3 As Third_Table = New Third_Table
    ...
    '------
    Public Table4 As Fourth_Table = New Fourth_Table
    ...
    '------
    Public Table5 As Fifth_Table = New Fifth_Table
